...
const ROLE_ALLOWED_STAFF_TYPES: Record<string, StaffType[]> = {
  SUPER_USER: ["TECHNICIAN", "BAR_VOLUNTEER", "FOH_VOLUNTEER", "DUTY_MANAGER", "STAIR_CLIMBER_OPERATOR", "SETUP_VOLUNTEER"],
  BOOKINGS_ADMIN: ["FOH_VOLUNTEER", "DUTY_MANAGER", "STAIR_CLIMBER_OPERATOR", "SETUP_VOLUNTEER"],
  TECH_ADMIN: ["TECHNICIAN", "STAIR_CLIMBER_OPERATOR"],
  BAR_ADMIN: ["BAR_VOLUNTEER", "SETUP_VOLUNTEER"],
};
